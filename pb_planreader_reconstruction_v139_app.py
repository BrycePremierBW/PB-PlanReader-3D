"""PlanReader v1.4.5 complete reconstruction stack with Accuracy v1.3 deterministic engines."""
...
from pb_accuracy_v13_engines_v145 import apply as apply_accuracy_v13_engines_v145
...
# Deterministic room topology, overhead-scope, cross-view QA and evidence-bound semantic engines.
apply_accuracy_v13_engines_v145(base.launcher.app)
...
base.launcher.app.APP_VERSION = "1.4.5"
